...
public class CnaAesUtil {
	...
	private static String doAes(String key,String data, int mode, String code) {
		try {
			...
			CnaLogUtil.error(log,"AES 密文处理异常,key:{},data:{},mode:{},code:{},message:{}",key,data,mode,code,e.getMessage(),e);
		}
		return null;
	}
	 ...
	 * @return 二进制数组
	 */
	public static byte[] base64Dncode(String data) throws Exception{
