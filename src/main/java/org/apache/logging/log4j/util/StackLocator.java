...
import cn.cnaworld.framework.infrastructure.utils.log.CnaLogger;
...
public final class StackLocator {
    ...
    public static final String CNA_LOGGER = CnaLogger.class.getName();

    public static final String CNA_LOGUTIL = CnaLogUtil.class.getName();
    ...
    public Deque<Class<?>> getCurrentStackTrace() {
        ...
        if (org.apache.logging.log4j.util.PrivateSecurityManagerStackTraceUtil.isEnabled()) {
            return org.apache.logging.log4j.util.PrivateSecurityManagerStackTraceUtil.getCurrentStackTrace();
        }
    ...
    public StackTraceElement calcLocation(final String fqcnOfLogger) {
        ...
        for (int i = 0; i < stackTrace.length; i++) {
            ...
            if (found) {
                if (CNA_LOGGER.equalsIgnoreCase(className)) {
                    foundCnaLog=true;
                    continue;
                }
                if(foundCnaLog){
                    if (CNA_LOGUTIL.equalsIgnoreCase(className)) {
